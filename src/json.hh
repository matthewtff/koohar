...
public:
	...
	Object () : m_state(OnValue), m_type(Undefined), m_boolean(false),
		m_integer(0L), m_float(.0)
	{}
	explicit Object(const bool Bool) : m_state(OnSuccess), m_type(Boolean),
		m_boolean(Bool), m_integer(0L), m_float(.0)
	{}
	explicit Object(const long Int) : m_state(OnSuccess), m_type(Integer),
		m_boolean(false), m_integer(Int), m_float(.0)
	{}
	explicit Object(const double Floating) : m_state(OnSuccess), m_type(Float),
		m_boolean(false), m_integer(0L), m_float(Floating)
	{}
	explicit Object(const std::string& Str) : m_state(OnSuccess),
		m_type(String), m_boolean(false), m_integer(0L), m_float(.0),
		m_string(Str)
	{}
